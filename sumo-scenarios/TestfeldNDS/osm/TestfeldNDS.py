...
subprocess.call(
    'osmfilter TestfeldNDS.o5m --keep-ways="highway=primary =primary_link =secondary =secondary_link =trunk =trunk_link =motorway =motorway_link" --keep-nodes= --keep-relations= --out-o5m | osmconvert - | gzip > TestfeldNDS_main_roads.osm.xml.gz',
    shell=True,
)
